...
<body>
    <form method="POST">
        <label >PROMO MATAL!! SEMUA BARANG HARGA DISKON 10%</label> <br><br>
    ...
    <?php
        if ($_POST):
            ...
            $total_barang1 = ($harga1 * (1-$diskon1)* $jumlah1);
            $total_barang2 = ($harga2 * (1-$diskon2)* $jumlah2);
            $total_harga = ($total_barang1 + $total_barang2);
            ...
            echo "Diskon barang = " .$diskon1. "<br>";
            echo "Total Harga = " .$total_barang1. "<br><br>";

            echo "Barang 2<br>";
            echo "Nama Barang = " .$barang2. "<br>";
            echo "Harga = Rp. " .$harga2. "<br>";
            echo "Jumlah = " .$jumlah2. "<br>";
            echo "Diskon barang = " .$diskon2. "<br>";
            echo "Total Harga = " .$total_barang2. "<br><br>";
